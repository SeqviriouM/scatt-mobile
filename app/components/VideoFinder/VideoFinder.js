    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Touchable style={styles.settingsIcon} onPress={this.onPressSettings}>
                    <Svg width="30" height="30" x="0" y="0" scale={2} viewBox="0 0 478.703 478.703" fill="#263238">
                ...
                <Link component={Touchable} to="/create/user" style={styles.back}>
